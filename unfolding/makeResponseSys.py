...
if not args.sys:
  ...
  mList.append(Plot2D('perf_unfReco_Z_pt',           'p_{T}(ll) (GeV)',    lambda c : min(protectedZpt(c                                                              , 0. ) ,ZptBinRec[-1]       -0.001 )   ,ZptBinRec     , 'gen p_{T}(ll) (GeV)', lambda c : min(       plZpt(c)                                                                     ,ZptBinRec[-1]       -0.001 )   ,ZptBinRec     ))
  mList.append(Plot2D('perf_unfReco_l1l2_ptsum',           'p_{T}(l1)+p_{T}(l2) (GeV)',    lambda c : min(ifRec(c, c.l1_pt+c.l2_pt                                                              , 0. ) ,l1l2ptBinRec[-1]       -0.001 )   ,l1l2ptBinRec     , 'gen p_{T}(l1)+p_{T}(l2) (GeV)', lambda c : min(       c.PLl1_pt+c.PLl2_pt                                                                     ,l1l2ptBinRec[-1]       -0.001 )   ,l1l2ptBinRec     ))
