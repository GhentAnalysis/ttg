...
newBranches += ['PLbj1/I', 'PLbj2/I', 'PLlbDeltaR/F', 'PLbbDeltaR/F', 'PLllDeltaR/F']
...
from ttg.unfolding.THEORYobjectSelection import PLselectLeptons, PLselectPhotons, PLgoodJets, PLbJets, PLmakeInvariantMasses, PLmakeDeltaR
#
# Start selection
#
