...
offZfile = '/storage_mnt/storage/user/gmestdac/public_html/ttG/2016/phoCB-NPcontrib-passChgIso-normalize-norat/noData/llg-mll40-signalRegion-offZ-llgNoZ-photonPt20/photon_SigmaIetaIeta_small.pkl'
onZfile = '/storage_mnt/storage/user/gmestdac/public_html/ttG/2016/phoCB-NPcontrib-passChgIso-normalize-norat/noData/llg-mll40-signalRegion-onZ-llgNoZ-photonPt20/photon_SigmaIetaIeta_small.pkl'
...
onZ.Draw('hist same')
legend.Draw()
c1.SaveAs('sigmaOnOffZsmall.png')
