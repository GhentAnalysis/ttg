...
pho = root2array(sets[args.sampleSet], treename="blackJackAndHookersTree", selection = "_phSigmaIetaIeta > 0.012", branches = "ph", warn_missing_tree = True)
sigVals = root2array(sets[args.sampleSet], treename="blackJackAndHookersTree", selection = "_phSigmaIetaIeta > 0.012", branches = "_phSigmaIetaIeta", warn_missing_tree = True)
CIsVals = root2array(sets[args.sampleSet], treename="blackJackAndHookersTree", selection = "_phSigmaIetaIeta > 0.012", branches = "_phChargedIsolation", warn_missing_tree = True)
...
decomp = decomposition.FastICA(2)
decomp.fit_transform(vals)
print decomp.components_

# kerpca = decomposition.kernelPCA(n_components=2, kernel="poly")
# kerpca.fit_transform(vals)
# print(args.sampleSet)
# print kerpca.components_