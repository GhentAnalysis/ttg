...
def phoClosure(CRTF, CRLF, SRTF, SRLF, CRTH, CRLH, SRTH, SRLH, outName, plotName): 
  ...
  binmax = 1.5 * max([crtf.GetBinContent(bin) for bin in range(1, nbins)] + [srth.GetBinContent(bin) for bin in range(1, nbins)] + [crtf.GetBinContent(bin) for bin in range(1, nbins)] + [srth.GetBinContent(bin) for bin in range(1, nbins)])
...
for plot in ['photon_pt_large','photon_eta_large','yield', 'signalRegions', 'njets']:  
    try: phoClosure(basePath + 'phoCB-passChgIso-sidebandSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet2p-deepbtag1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-sidebandSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet2p-deepbtag1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet2p-deepbtag1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-passSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet2p-deepbtag1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-sidebandSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet2p-deepbtag1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-sidebandSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet2p-deepbtag1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet2p-deepbtag1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-passSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet2p-deepbtag1p-photonPt20/'+ plot + '.pkl',
                      'newPlots/' + plot + '_njet2pbjet1p.pdf',
                  plot
                  )
    except Exception as e:
      print(e)
    try: phoClosure(basePath + 'phoCB-passChgIso-sidebandSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-sidebandSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-passSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-sidebandSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-sidebandSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-passSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
    ...
    try: phoClosure(basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLFake/noData/llg-mll40-onZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-passSigmaIetaIeta-ALLFake/noData/llg-mll40-onZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-passSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLHad/noData/llg-mll40-onZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-passSigmaIetaIeta-ALLHad/noData/llg-mll40-onZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-failChgIso-passSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
      ...
      print(e)
    try: phoClosure(basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLFake/noData/llg-mll40-onZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-sidebandSigmaIetaIeta-ALLFake/noData/llg-mll40-onZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-sidebandSigmaIetaIeta-ALLFake/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLHad/noData/llg-mll40-onZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-sidebandSigmaIetaIeta-ALLHad/noData/llg-mll40-onZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-passSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
                      basePath + 'phoCB-passChgIso-sidebandSigmaIetaIeta-ALLHad/noData/llg-mll40-offZ-llgNoZ-njet1p-photonPt20/'+ plot + '.pkl',
