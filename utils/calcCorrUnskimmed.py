...
sig = numpy.concatenate(numpy.array(root2array("dcap://maite.iihe.ac.be//pnfs/iihe/cms/store/user/gmestdac/heavyNeutrino/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/crab_MiniAOD2017v2-v1_2017-v1/190524_204509/0000/dilep_1.root", treename="blackJackAndHookers/blackJackAndHookersTree", branches = "_phSigmaIetaIeta",   warn_missing_tree = True)))
cha = numpy.concatenate(numpy.array(root2array("dcap://maite.iihe.ac.be//pnfs/iihe/cms/store/user/gmestdac/heavyNeutrino/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/crab_MiniAOD2017v2-v1_2017-v1/190524_204509/0000/dilep_1.root", treename="blackJackAndHookers/blackJackAndHookersTree", branches = "_phChargedIsolation", warn_missing_tree = True)))
...
log.info(pearsonr(sig,cha))
# for a, b in zip(sig,cha):
#   log.info(a)
#   log.info(b)
#   log.info("-------------")
