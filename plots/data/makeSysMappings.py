    ...
    for line in template:
      if line.count('STATERRORS'):
        for sample, sampleTex in [('TTGamma', 't#bar{t}#gamma'), ('TT_Dil', 't#bar{t}'), ('ZG', 'Z#gamma'), ('DY', 'Drell-Yan'), ('VVTo2L2Nu', 'Other'), ('singleTop', 'singleTop')]:
          for signs in ['emu', 'ee', 'mumu']:
            ...
            for signs in ['ee', 'mumu']:
              ...
              mapping.write('  "np_' + signs + sample + 'Stat' + i + '" : "Stats ' + sampleTex + ' ' + mult + ' (nonpromptCR ' + signs + ')",\n')
        for i, mult in [('2', '2j,0b'), ('3', '#geq3j,0b'), ('4', '1j,1b'), ('5', '2j1b'), ('6', '#geq3j,1b'), ('7', '2j2b'), ('8', '#geq3j,2b')]:   # AutoMCStats, bin numbering starts at 0!
          ...
          mapping.write('  "prop_binnp_ee_bin' + i + '" : "Stats ' + mult + ' (ee np CR)",\n')
          mapping.write('  "prop_binnp_mumu_bin' + i + '" : "Stats ' + mult + ' (mumu np CR)",\n')
      else:
        mapping.write(line)