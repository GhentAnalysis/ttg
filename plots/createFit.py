...
for pseudoData in [True, False]:
  for channel in ['ee', 'emu', 'mumu']:
    ...
    randomConeSelection    = getHist('eleCB-phoCBnoChgIso',      channel, selection, 'photon_randomConeIso', ['data'])
    sigmaIetaIetaSideBand  = getHist('sigmaIetaIetaMatchMC',     channel, selection, 'photon_chargedIso',    ['data'])
    if pseudoData:
      chargedIsoTTGamma    = getHist('eleCB-phoCBnoChgIso',      channel, selection, 'photon_chargedIso',    ['t#bar{t}#gamma (2l)'])
      chargedIsoTTGamma.Add( getHist('eleCB-phoCBnoChgIso',      channel, selection, 'photon_chargedIso',    ['t#bar{t}#gamma (1l)']))
      chargedIsoOther      = getHist('eleCB-phoCBnoChgIso',      channel, selection, 'photon_chargedIso',    ['TTJets'])
      chargedIsoOther.Add(   getHist('eleCB-phoCBnoChgIso',      channel, selection, 'photon_chargedIso',    ['Z#gamma']))
      chargedIsoOther.Add(   getHist('eleCB-phoCBnoChgIso',      channel, selection, 'photon_chargedIso',    ['Drell-Yan']))
      chargedIsoOther.Add(   getHist('eleCB-phoCBnoChgIso',      channel, selection, 'photon_chargedIso',    ['single-t']))
      chargedIsoOther.Add(   getHist('eleCB-phoCBnoChgIso',      channel, selection, 'photon_chargedIso',    ['multiboson']))
      chargedIsoOther.Add(   getHist('eleCB-phoCBnoChgIso',      channel, selection, 'photon_chargedIso',    ['t#bar{t}+V']))
      chargedIsoTTGamma.Scale(1)
      ...
      chargedIsoData      = getHist('eleCB-phoCB',              channel, selection, 'photon_chargedIso',    ['data'])
