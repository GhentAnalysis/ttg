...
if args.tag.count('randomConeCheck'):
  ...
  plots.append(Plot('signalRegions',              'signal region',                        lambda c : signalRegions(c),                                   (10, 0, 10), histModifications=xAxisLabels(['1j,0b', '1j,1b','#geq2j,0b','#geq2j,1b','#geq2j,#geq2b','1j,0b', '1j,1b','#geq2j,0b','#geq2j,1b','#geq2j,#geq2b'])))
