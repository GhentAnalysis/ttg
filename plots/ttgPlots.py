...
plots.append(Plot('photon_hadOverEm',       'hadronicOverEm(#gamma)',          lambda c : c._phHadronicOverEm[c.ph],                     (20,0,.05)))
...
for sample in sum(stack, []):
  c = sample.initTree(reducedType = 'electronCutBased' if eleCB else 'electronMvaMedium')
  first = True
